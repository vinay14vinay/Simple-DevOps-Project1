...
#### From Jenkins home page select "New Item"
   ...
   - *Source Code Management:*
      ...
      - Repository:  `https://github.com/vinay14vinay/hello-world.git`
  ...
  - *Post-build Actions*  
    - Send build artifacts over SSH  
      - *SSH Publishers*  
	       - Exec command: 
                ```sh 
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-vinay-deployment.yml;
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-vinay-service.yml;
                ```
Save and run the job.
